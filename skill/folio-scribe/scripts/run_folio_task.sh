...
4. 用 write_daily_note.py 写入 vault，section 用「港股计划」，加 --chinese 参数
...
4. 用 write_daily_note.py 写入 vault，section 用「港股总结」，加 --chinese 参数
...
4. 用 write_daily_note.py 写入 vault，section 用「美股计划」，加 --chinese 参数
...
4. 用 write_daily_note.py 写入 vault，section 用「美股总结」，加 --chinese 参数
